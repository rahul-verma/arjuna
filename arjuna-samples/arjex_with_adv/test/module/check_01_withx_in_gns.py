...
def check_withx_in_leftnav_gns_file(request, dashboard):
    dashboard.left_nav.element("posts").click()
    dashboard.left_nav.element("media").click()
    dashboard.left_nav.element("pages").click()
    dashboard.left_nav.element("comments").click()