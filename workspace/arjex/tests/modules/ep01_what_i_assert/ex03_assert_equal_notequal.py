...
def assert_equal_fails_for_nonequal_strings(my):
    my.steps.assert_equals("Should fail for Non equal strings", "testing", "testing ")
...
def assert_equal_fails_for_nonequal_booleans(my):
    my.steps.assert_equals("Should fail for Non equal booleans", True, False)
...
def assert_equal_errs_for_incompatible_values(my):
    my.steps.assert_equals("Should err for int and string comparison", 1, "testing")
...
def assert_equal_with_expected_value_as_none(my):
    my.steps.assert_equals("Should fail.", None, 1)


@test_function
def assert_notequal_with_expected_value_as_none(my):
    my.steps.assert_equals("Should pass", None, None)