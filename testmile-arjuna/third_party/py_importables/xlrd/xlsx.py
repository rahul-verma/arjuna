...
U_CP = "{http://schemas.openxmlformats.org/package/2006/metadata/test-properties}"
...
X12_MAX_ROWS = 2 ** 20
X12_MAX_COLS = 2 ** 14
V_TAG = U_SSML12 + 'v'  # cell child: types
...
def cnv_xsd_boolean(s):
    ...
    if s in ("0", "false", "off"):
        return 0
    raise ValueError("unexpected xsd:boolean types: %r" % s)
