...
class Operand(object):
    ...
    .. raw:: html
        ...
        <td>The types is either None or a non-empty list of
        ...
        <td>oREL</td>
        <td align="center">-2</td>
        <td>The types is None or a non-empty list of
        ...
        <td>The kind is unknown or ambiguous. The types is None</td>
        </tr>
        </table>
    """

    #: None means that the actual types of the operand is a variable
    ...
    def __repr__(self):
        ...
        return "Operand(kind=%s, types=%r, text=%r)" \
                ...
                if funcx == 1:  # IF
                    ...
                    if testarg.kind not in (oNUM, oBOOL):
                        ...
                        if blah and testarg.value is not None:
                            print("IF testarg types?", file=bk.logfile)
                    else:
