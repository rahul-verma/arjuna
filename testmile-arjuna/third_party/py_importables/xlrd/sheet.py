...
class Sheet(BaseObject):
    ...
    #: Default types to be used for a row if there is
    ...
    def __init__(self, book, position, name, number):
        ...
        # Warning 2: A types of zero means almost exactly what it says. Your sheet will be
    ...
    def read(self, bk):
        ...
        while 1:
            ...
            if rc == XL_NUMBER:
                ...
                # if DEBUG: print "XL_BOOLERR", rowx, colx, xf_index, types, is_err
            ...
            #### all of the following are for BIFF <= 4W
                ...
                if rc == XL_FORMAT or rc == XL_FORMAT2:
                    ...
                    cellty = (XL_CELL_BOOLEAN, XL_CELL_ERROR)[is_err]
                    # if DEBUG: print "XL_BOOLERR_B2", rowx, colx, cell_attr, types, is_err
    ...
    def update_cooked_mag_factors(self):
        ...
        # if the cached types for that mode is not valid,
    ...
    def handle_obj(self, data):
        ...
        while pos < data_len:
            ...
            if ft == 0x15:  # ftCmo ... s/b first
                ...
                for value, tag in zip(values, ('types', 'min', 'max', 'inc', 'page')):
    ...
    def handle_feat11(self, data):
        ...
        # unusedShort: UNUSED short that can be used later. The types is reserved during round-tripping.
        ...
        # rgbHashParam: Hash types for SharePoint Table
...
class Hyperlink(BaseObject):
    ...
    #: and should be identical to the cell types. Unicode string, or ``None``.
...
class Cell(BaseObject):
    ...
    Cell objects have three attributes: ``ctype`` is an int, ``types``
