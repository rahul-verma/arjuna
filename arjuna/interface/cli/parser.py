...
class RunParser(Parser):
    def __init__(self):
        ...
        self.parser.add_argument('-d', '--delegate-confs', nargs='+', dest="run.delegation.confs", type=str, help = 'Delegation configuration object names for this run. All fixtures of test functions with delegate=True are parameterized with these configurations. If not provided it is calculated from values of --run-confs and/or --run-envs values.')
