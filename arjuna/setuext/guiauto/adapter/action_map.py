...
HANDLER_MAP = {
    ...
    GuiAutoActionType.ELEMENT_CONFIGURE: 4,

    GuiAutoActionType.MULTIELEMENT_GET_INSTANCE_COUNT: 12,
    GuiAutoActionType.MULTIELEMENT_GET_RANDOM_INDEX: 12,
    
    GuiAutoActionType.DROPDOWN_CONFIGURE: 5,
    GuiAutoActionType.DROPDOWN_SET_OPTION_LOCATORS: 5,
    GuiAutoActionType.DROPDOWN_SET_OPTION_CONTAINER: 5,
