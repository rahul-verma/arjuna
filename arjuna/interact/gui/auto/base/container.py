...
class ElementContainer(metaclass=abc.ABCMeta):
    ...
    def get_element_finder(self):
        return self.__element_finder

    def get_max_wait_time(self):
        return self.get_config().value("guiauto.max.wait")

    def wait_until_element_absent(self, lmd, max_wait_time=None):
        max_wait_time = max_wait_time and max_wait_time or self.get_max_wait_time()
    ...
    def load_multielement(self, multi_guielement, max_wait_time=None):
        ...
        multi_guielement.set_located_with(locator_type, locator_value)
        multi_guielement.dispatcher = dispatcher
        multi_guielement.set_size(size)
    ...
    def load_element(self, gui_element, max_wait_time=None):
        ...
        gui_element.set_located_with(locator_type, locator_value)
