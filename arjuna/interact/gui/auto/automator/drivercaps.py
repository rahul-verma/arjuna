...
class DriverCapabilities:
    ...
    def __init__(self, config, json_dict):
        ...
        self.__host_os = self.__config.arjuna_options.value(ArjunaOption.TESTRUN_HOST_OS).lower()
        aname = self.__config.arjuna_options.value(ArjunaOption.AUTOMATOR_NAME).lower()
        acontext = self.__config.arjuna_options.value(ArjunaOption.GUIAUTO_CONTEXT).lower()
        mobile_platform = self.__config.arjuna_options.value(ArjunaOption.MOBILE_OS_NAME).lower()
    ...
    def __process_config(self, config):
        self.__out_dict["automationContext"] = config.arjuna_options.value(ArjunaOption.GUIAUTO_CONTEXT).upper()
    ...
    def __process_for_selenium(self, in_dict):
        browser_name = self._config.arjuna_options.value(ArjunaOption.BROWSER_NAME).lower()
    ...
    def __process_for_appium(self, dict_from_requester):
        mobile_os_name = self._config.arjuna_options.value(ArjunaOption.MOBILE_OS_NAME)
