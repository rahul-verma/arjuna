...
class GuiAutomator(ElementContainer,Dispatchable):
    ...
    def __init__(self, app, config, ext_config=None):
        ...
        self.__in_slomo = config.get_arjuna_option_value(ArjunaOption.GUIAUTO_SLOMO_ON)
        self.__slomo_interval = config.get_arjuna_option_value(ArjunaOption.GUIAUTO_SLOMO_INTERVAL)
        ...
        self.__browser = None
        self.__screenshots_dir = config.get_arjuna_option_value(ArjunaOption.PROJECT_RUN_SCREENSHOTS_DIR)
    ...
    def __create_screenshots_dir(self):
        sdir = self.config.get_arjuna_option_value(ArjunaOption.PROJECT_RUN_SCREENSHOTS_DIR)
