...
#         self.__tab_content_wmd = self.__automator.create_wmd(with_obj)
...
#         self.__tab_content = self.__tab_grouptab_group.root.element(self.__tab_content_wmd)
...
#     def __init__(self, automator, wmd, *, tab_header_wmd, content_relation_attr, content_relation_type, parent=None):
#         super().__init__(automator)
#         self.__root = automator.define_element(wmd)
#         tabs = self.root.define_element(tab_header_wmd).identify()
#         self.__tabs = []
