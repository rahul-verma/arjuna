...
from arjuna.lib.setu.dispatcher.setu_actor_requester import SetuActorRequester
    ...
    def __init__(self, config, setu_id):
        ...
        if self.__actor_mode == SetuActorMode.REMOTE:
            ...
            if (self.__automator_name == GuiAutomatorName.SELENIUM):
                from arjuna.lib.setu.dispatcher.guiauto.selenium.remote.driver import SeleniumDriver 
            ...
            if (self.__automator_name == GuiAutomatorName.SELENIUM):
                from arjuna.lib.setu.dispatcher.guiauto.selenium.local.driver import SeleniumDriver 
