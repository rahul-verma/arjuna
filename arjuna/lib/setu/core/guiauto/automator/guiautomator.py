...
from arjuna.lib.setu.core.guiauto.base.element_container import ElementContainer
from arjuna.lib.setu.core.guiauto.element.guielement import GuiElement
from arjuna.lib.setu.core.guiauto.element.multielement import GuiMultiElement
from arjuna.lib.setu.core.guiauto.locator.emd import SimpleGuiElementMetaData
...
class GuiAutomator(ElementContainer):
    ...
    def launch(self):
        ...
        from arjuna.lib.setu.core.guiauto.element.window import MainWindow
