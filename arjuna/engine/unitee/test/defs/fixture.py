...
from arjuna.engine.unitee.test.objects.fixture import Fixture
from arjuna.engine.unitee.enums import FixtureTypeEnum
from arjuna.engine.unitee.loader import kfactory
...
class ConfiguredFixtureHelper:
    ...
    def configure_fixture(fixdef, ftypestr, mname, fname):
        ...
        fix_prefix = Arjuna.get_central_config().get_arjuna_option_value(ArjunaOption.UNITEE_PROJECT_FIXTURES_IMPORT_PREFIX).as_str()
