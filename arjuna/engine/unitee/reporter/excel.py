...
from arjuna.engine.unitee.reporter.result.types import SteppedResult
...
class ExcelReporter:
    ...
    def __init__(self):
        ...
        self.path = Arjuna.get_central_config().get_arjuna_option_value(ArjunaOption.UNITEE_PROJECT_RUN_REPORT_DIR).as_str() + "/ArjunaTestReport.xls"
