...
from arjuna.engine.unitee.reporter.mcr import *
from arjuna.engine.unitee.reporter.cr import *
from arjuna.engine.unitee.reporter.excel import *
...
class ActiveReporter(__Reporter):
    ...
    def __init__(self):
        ...
        rdir = Arjuna.get_ref_config().get_arjuna_option_value(ArjunaOption.REPORT_DIR).as_str()
        file_utils.delete_dir_if_exists(rdir)
        self.__rr_dir = Arjuna.get_ref_config().get_arjuna_option_value(ArjunaOption.UNITEE_PROJECT_RUN_REPORT_DIR).as_str()
        os.makedirs(self.__rr_dir)

    def set_up(self):
        active_formats = Arjuna.get_ref_config().get_arjuna_option_value(
